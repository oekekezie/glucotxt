...
// Scripted responses for the Spanish language
const Reference = {
  localizationType: 'esp',
  ...
  // Default error
  defaulterror: `[Oops! Something went wrong for some reason. Please try again or contact us at ${contact}.]`,

  // Sent to new patients
  invitation: `[Welcome to ${app}! (For English reply "Eng" now..) (1) To log a blood sugar measurement just send us the numeric value, for example "120", and we will do the rest. (2) To view or share your log at any time, reply "Log" and we will send you an access code with instructions. (3) Reply “Stop” to quit using our service at anytime or "?" for more information.]`,

  // Set language to English
  setlanguagepreferencesuccess: `[Your language was set to Spanish. (For English reply "Eng" now..) Thanks for using ${app}!]`,
  setlanguagepreferenceunnecessary: `[Your language is already set to Spanish. (For English reply "Eng" now..) Thanks for using ${app}!]`,
